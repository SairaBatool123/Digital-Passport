...
import AddCategoryModal from "@/views/ecommerce/manufacturer/components/AddCategoryModal";
import { LuDownload, LuPlus, LuSearch } from "react-icons/lu";
import { TbChevronDown, TbEdit, TbEye, TbTrash } from "react-icons/tb";
import { manufacturer } from "@/views/ecommerce/manufacturer/data";
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          <Dropdown align="end">
            <DropdownToggle className="btn-default drop-arrow-none">
              <LuDownload className="me-1" /> Export{" "}
              <TbChevronDown className="align-middle ms-1" />
            </DropdownToggle>
            <DropdownMenu>
          ...
          {/* ✅ Add button now toggles modal */}
          <Button variant="primary" onClick={toggleModal}>
            <LuPlus className="fs-sm me-1" /> Add Manufacturer
          </Button>
        </div>
      </CardHeader>
